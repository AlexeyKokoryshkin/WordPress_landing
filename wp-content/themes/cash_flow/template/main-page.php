...
<div class="b-feedbackForm">
	...
	<section id="form-popup" class="white-popup mfp-hide">
		<div id="message" class="decor">
				<h2><span>Форма</span> обратной связи</h2>
				<div id="contact-form">        
					<div class="controls">
							<div class="form-group">
							<label for="form_name"></label>
								<input required="" id="form_name" type="text" class="form-control" placeholder="Как к Вам обращаться?">
								<div class="help-block with-errors"></div>
							</div>
						
							<div class="form-group">
								<textarea id="form_message" name="text_comment" class="form-control" placeholder="Пожалуйста, оставьте нам сообщение и Ваши контактные данные (любой удобный для Вас способ связи)" rows="8" required data-error="Пожалуйста, оставьте нам сообщение"></textarea>
								<div class="help-block with-errors"></div>
							</div>
							<div class="messages"></div>

							<div class="form-group">
								<label for="bezspama"></label>
								<input id="form_capcha" name="bezspama" required type="text" style="display:none" value="" /> 
							</div> 
